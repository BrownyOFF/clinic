...
export default function PrivacyPolicyPage() {
  const sections = [
    ...
    },
    {
      ...
      content: "Під час відвідування нашого сайту деякі технічні дані збираються автоматично за допомогою аналітичних інструментів. Ми використовуємо Google Analytics та Cloudflare Analytics. Зібрана інформація може включати вашу IP-адресу, тип браузера, мову інтерфейсу, операційну систему, час перебування на сайті та переглянуті сторінки. Ці дані є знеособленими та використовуються виключно для технічного моніторингу та покращення роботи сайту."
    },
    {
      ...
      <main className="py-16 md:py-24 relative z-10 max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 rounded-3xl text-sm font-semibold text-slate-700 dark:text-slate-350 text-center">
            Остання зміна: 31 травня 2026 року
          </div>
        </div>
