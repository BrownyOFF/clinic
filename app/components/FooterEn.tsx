    ...
    <footer className="bg-slate-900 text-slate-300 py-16 border-t border-slate-800">
        ...
        <div className="lg:col-span-4">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center p-1">
               <Image src="/images/logo.png" alt="Sails of Life Logo" width={40} height={40} className="rounded-full object-contain" />
            </div>
            <span className="text-xl font-bold text-white tracking-tight">Sails of Life</span>
          </div>
          <p className="text-sm text-slate-400 leading-relaxed max-w-sm mb-6">
            Communal Non-Profit Enterprise "Center of Medical Rehabilitation and Palliative Care for Children" of Zhytomyr Regional Council.
          </p>
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-4">
            ...
            <ul className="space-y-3 text-sm flex-1">
              <li>
                <Link href="/en/about-us" className="flex items-center gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0" /> About Us
                </Link>
              </li>
              <li>
                <Link href="/en/directions" className="flex items-center gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0" /> Directions
                </Link>
              </li>
              <li>
                <Link href="/en/team" className="flex items-center gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0" /> Team
                </Link>
              </li>
              <li>
                <Link href="/en/news" className="flex items-center gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0" /> News
                </Link>
              </li>
              <li>
                <Link href="/en/vacancy" className="flex items-center gap-2 hover:text-blue-400 transition group">
            ...
            <ul className="space-y-3 text-sm flex-1">
              <li className="text-white text-xs font-bold uppercase tracking-wider mb-2 ml-6 sm:ml-0">For Patients:</li>
              <li>
                <Link href="/en/for-patient/documents" className="flex items-start gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0 mt-0.5" /> Documents
                </Link>
              </li>
              <li>
                <Link href="/en/for-patient/rehabilitation" className="flex items-start gap-2 hover:text-blue-400 transition group">
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-blue-400 shrink-0 mt-0.5" /> Rehabilitation
                </Link>
              </li>
              <li>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a href="https://maps.google.com/?q=Житомир,+вул.+Корабельна,+8" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-blue-400 transition group text-sm">
                ...
                <span>Zhytomyr,<br/>8 Korabelna St.</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between text-sm text-slate-400 gap-4 text-center md:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6">
          <Link href="/en/privacy-policy" className="font-medium text-slate-350 hover:text-white hover:underline underline-offset-4 transition-all duration-300">
            Privacy Policy
          </Link>
          ...
          <p>
            Website development —{" "}
            <a 
              href="https://github.com/BrownyOFF" 
              target="_blank" 
              rel="noopener noreferrer" 
