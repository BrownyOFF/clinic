      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-4">
          ...
          <ul className="space-y-4">
            <li>
              <a href="tel:+380674572828" className="flex items-center gap-3 hover:text-blue-400 transition group">
            ...
            <li>
              <a href="mailto:baby_house@ukr.net" className="flex items-center gap-3 hover:text-blue-400 transition group">
                <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-blue-900/50 transition">
                  <Mail size={16} />
                </div>
        ...
        <div className="md:col-span-3">
          ...
          <div className="flex items-center gap-3 mb-6 hover:text-blue-400 transition cursor-default">
              <MapPin size={18} className="text-slate-400" />
              <span>м. Житомир, вул. Корабельна, 8</span>
          </div>
          
          <div className="flex gap-4">
            <a href="https://www.facebook.com/vitrylazhyttia/" className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-600 hover:text-white transition duration-300 shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/babyzthouse/" className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center hover:bg-pink-600 hover:text-white transition duration-300 shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
