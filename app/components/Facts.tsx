...
const facts = [
  ...
  { id: 4, title: 'Сучасне обладнання', desc: 'Центр оснащений сучасною реабілітаційною та діагностичною апаратурою.', img: '/images/fact8.jpg' },
  ...
  { id: 6, title: 'Освітні програми', desc: 'Центр організовує навчання та тренінги для батьків, доглядульників та медичних працівників.', img: '/images/fact11.jpg' },
  ...
  { id: 8, title: 'Соціальна адаптація', desc: 'Фахівці допомагають дітям інтегруватися в суспільство, навчання, розвивати навички спілкування.', img: '/images/fact4.jpg' },
  ...
  { id: 11, title: 'Безперервність допомоги', desc: 'Медичне спостереження та догляд можуть тривати як у стаціонарі, так і вдома.', img: '/images/fact6.jpg' },
