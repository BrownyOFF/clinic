      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-4 z-50">
          ...
          <div className="hidden sm:flex bg-slate-100 dark:bg-slate-800 rounded-full p-1 ml-2">
            <Link href={ukrainianUrl} className="text-xs px-3 py-1.5 rounded-full text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-bold transition cursor-pointer">УКР</Link>
            <span className="text-xs px-3 py-1.5 rounded-full bg-white dark:bg-slate-700 text-blue-700 dark:text-blue-200 font-bold shadow-sm cursor-default">EN</span>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex bg-slate-100 dark:bg-slate-800 rounded-full p-1 mx-auto mt-2 w-max">
              <Link href={ukrainianUrl} className="text-sm px-6 py-2 rounded-full text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-bold transition cursor-pointer">УКР</Link>
              <span className="text-sm px-6 py-2 rounded-full bg-white dark:bg-slate-700 text-blue-700 dark:text-blue-200 font-bold shadow-sm cursor-default">EN</span>
            </div>
