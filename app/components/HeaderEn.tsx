          ...
          >
            <nav className="flex flex-col gap-5 text-lg font-medium text-slate-700 dark:text-slate-200">
              ...
              <div className="border-l-2 border-blue-500 pl-4 py-1 flex flex-col gap-4 bg-slate-50 dark:bg-slate-800/50 rounded-r-xl">
                ...
                <Link href="/en/for-patient/screening" onClick={closeMenu} className={`text-base transition cursor-pointer ${isActive('/en/for-patient/screening') ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-slate-600 dark:text-slate-300'}`}>Screening Assistant</Link>
                <Link href="/en/for-patient/documents" onClick={closeMenu} className={`text-base transition cursor-pointer ${isActive('/en/for-patient/documents') ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-slate-600 dark:text-slate-300'}`}>Required Documents</Link>
